...
public class Camera
{
	...
	/** rotates this camera around the local V axis by the specified amount */
    public void yaw(float amount)
    {   u.rotateAxis(amount, v.x(), v.y(), v.z());
        n.rotateAxis(amount, v.x(), v.y(), v.z());
    }

	/** rotates this camera around the local U axis by the specified amount */
